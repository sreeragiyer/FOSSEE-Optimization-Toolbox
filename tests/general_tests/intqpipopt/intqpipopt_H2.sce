...
//  !--error 10000 
// intqpipopt: Expected type ["constant"] for input argument H at input #1, but got "string" instead.
// at line      56 of function Checktype called by :  
// at line     190 of function intqpipopt called by :  
// [xopt,fopt,exitflag,output,lambda]=intqpipopt(H,f,intcon,A,b,[],[],lb,ub)
// at line      20 of exec file called by :    
// exec intqpipopt_H2.sce
