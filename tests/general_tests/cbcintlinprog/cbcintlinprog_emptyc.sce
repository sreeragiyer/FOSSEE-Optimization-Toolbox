...
[x,f,status,output] = cbcintlinprog([],intcon,A,b,Aeq,beq,lb,ub)
//!--error 10000 
//cbcintlinprog: Cannot determine the number of variables because input objective coefficients is empty
//at line     172 of function cbcintlinprog called by :  
//[x,f,status,output] = cbcintlinprog([],intcon,A,b,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec cbcintlinprog_emptyc.sce
