...
[x,f,status,output] = cbcintlinprog(c,intcon,b,b,Aeq,beq,lb,ub)

// !--error 10000 
//cbcintlinprog: The size of inequality constraint is not equal to the number of variables
//at line     128 of function cbcmatrixintlinprog called by :  
//at line     203 of function cbcintlinprog called by :  
//[x,f,status,output] = cbcintlinprog(c,intcon,b,b,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec cbcintlinprog_A.sce
