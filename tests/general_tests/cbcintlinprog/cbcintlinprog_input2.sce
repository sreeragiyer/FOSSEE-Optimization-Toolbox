...
// !--error 10000 
//cbcintlinprog: Unexpected number of input arguments : 10 provided while should be in the set [4 6 8 9]
//at line     152 of function cbcintlinprog called by :  
//[x,f,status,output] = cbcintlinprog(c,intcon,A,b,Aeq,beq,lb,ub,[],[])
//at line      27 of exec file called by :    
//exec cbcintlinprog_input2.sce
