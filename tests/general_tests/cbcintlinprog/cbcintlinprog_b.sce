...
[x,f,status,output] = cbcintlinprog(c,intcon,A,A,Aeq,beq,lb,ub)

// !--error 10000 
//cbcintlinprog: Constraint Upper Bound should be a vector
//at line     193 of function cbcmatrixintlinprog called by :  
//at line     203 of function cbcintlinprog called by :  
//[x,f,status,output] = cbcintlinprog(c,intcon,A,A,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec cbcintlinprog_b.sce
